<template>
  <div class="screen active">
    <div class="game-container">
      ...
      <div class="game-header">
        ...
        <div class="round-info">
          <div class="round-number">
            第 {{ gameState.room.currentRound }} 回合
          </div>
          <div 
      ...
      <!-- 连接状态提示 -->
      <div
        v-if="connectionMessage && connectionStatus !== 'connected'" 
      ...
      <!-- 当前情报官信息 -->
      <div
        v-if="currentEncryptorInfo && !isPaused"
        class="current-encryptor"
      >
      ...
      >
        ...
        <div class="phase-panel">
          ...
          <template v-if="gameState.room.phase === 'encrypting'">
            <div
              v-if="gameState.isEncryptor"
              class="phase-content"
            >
              <div
                class="encryptor-badge"
            ...
            <div
              v-else-if="gameState.isTeammate"
              class="phase-content"
            >
              <div class="phase-title">
                等待情报
            ...
            <div
              v-else-if="gameState.isOpponent"
              class="phase-content"
            >
              <div class="phase-title">
                敌方加密中
          ...
          <template v-else-if="gameState.room.phase === 'guessing' || gameState.room.phase === 'team_voting'">
            <!-- 队友猜测 -->
            <div
              v-if="gameState.isTeammate && !hasSubmittedTeamGuess"
              class="phase-content"
            >
              <div class="phase-title">
                解码情报
            ...
            <!-- 对方拦截 -->
            <div
              v-else-if="gameState.isOpponent && !hasSubmittedOpponentGuess"
              class="phase-content"
            >
              <div class="phase-title">
                拦截密码
            ...
            <!-- 拦截方投票 -->
            <div
              v-else-if="gameState.room.phase === 'team_voting' && gameState.isOpponent && needOpponentVote"
              class="phase-content"
            >
              <div class="vote-panel">
                ...
                <!-- 自定义密码输入 -->
                <div
                  v-if="selectedOpponentVote === opponentVoteOptions.length"
            ...
            <!-- 投票阶段 -->
            <div
              v-else-if="gameState.room.phase === 'team_voting' && gameState.isTeammate && needTeamVote"
              class="phase-content"
            >
              <div class="vote-panel">
                <div class="vote-title">
                ...
                <!-- 自定义密码输入 -->
                <div
                  v-if="selectedVote === voteOptions.length"
                  class="custom-code-input"
                  style="margin-top: 1rem;"
                >
                  <div class="code-inputs">
            ...
            >
              ...
              <p
                v-if="gameState.isEncryptor"
                style="text-align: center; margin-top: 1rem; font-family: var(--typewriter);"
              >
          ...
          <template v-else-if="gameState.room.phase === 'result'">
            <div class="phase-content">
              ...
              <div style="text-align: center; margin: 1.5rem 0;">
                ...
                <p
                  style="font-size: 1.1rem; line-height: 1.8; font-family: var(--serif);"
                  v-html="gameState.room.roundResult?.message"
                />
                <!-- eslint-enable vue/no-v-html -->
              </div>
              <div style="background: rgba(0,0,0,0.05); border: 2px solid var(--telegram-border); padding: 1rem; margin-bottom: 1rem;">
                <p style="font-family: var(--typewriter);">
                  <strong>正确密码:</strong> {{ gameState.room.roundResult?.correctCode?.join(' - ') }}
                </p>
                <p
                  v-if="gameState.room.roundResult?.teammateGuess"
                  style="font-family: var(--typewriter);"
                >
        ...
        <div class="note-sheet">
          <div class="note-section">
            ...
            <div
              v-if="ourNotes.length === 0"
              style="color: rgba(0,0,0,0.3); font-style: italic; font-family: var(--typewriter);"
            >
              暂无记录
            </div>
            <div 
            ...
            >
              ...
              <span
                class="note-result"
                :class="{ success: note.success, fail: !note.success }"
              >
                {{ note.success ? '✓' : '✗' }}
              </span>
            </div>
