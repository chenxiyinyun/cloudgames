      ...
      <div class="result-panel">
        ...
        <div class="result-details">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; text-align: center;">
            <div>
              <h4 style="color: var(--ink-black); font-family: var(--typewriter);">
                白队
              </h4>
              <p style="font-family: var(--typewriter);">
                拦截: {{ whiteInterception }}/2
              </p>
              <p style="font-family: var(--typewriter);">
                失误: {{ whiteMiscommunication }}/2
              </p>
            </div>
            <div>
              <h4 style="color: var(--ink-brown); font-family: var(--typewriter);">
                黑队
              </h4>
              <p style="font-family: var(--typewriter);">
                拦截: {{ blackInterception }}/2
              </p>
              <p style="font-family: var(--typewriter);">
                失误: {{ blackMiscommunication }}/2
              </p>
            </div>
          </div>
        </div>
